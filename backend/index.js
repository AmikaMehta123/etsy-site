...
app.use(cors({ origin: ['http://44.202.37.89:3000'], methods: ["GET", "POST"], credentials: true }));
...
app.use(function(req, res, next) {
        res.setHeader('Access-Control-Allow-Origin', 'http://44.202.37.89:3000');
...
app.listen(3002 ,"http://44.202.37.89", function () {
